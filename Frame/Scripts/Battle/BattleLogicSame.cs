...
namespace Demo
{
    public partial class BattleLogic
    {
        ...
        //结果信息
        public float damage;
        public float roleAniDurationTime = 1f; //动画持续的时间
        public float monsterAniDurationTime = 1f; //动画持续的时间
        ...
        void SkillClick(GameObject obj)
        {
            ...
            //TODO 沉默使用普攻
            if (SkillEffect.Instance.attack_roleIns.m_RoleInfo.isSilience ||
                SkillEffect.Instance.attack_roleIns.m_RoleInfo.isForceAttack)
            {
        ...
        {
            //被动取消点击效果
            if (skill2.name.Equals(SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillid2.ToString()) &&
                SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillCd2 == 0)
            {
                skill2.GetComponent<Button>().transition = Selectable.Transition.None;
            }
            else if (skill3.name.Equals(SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillid3.ToString()) &&
                     SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillCd3 == 0)
            {
        ...
        void GetMonsterTargetInfo(GameObject obj)
        {
            if (JudgeSkillCDCanUse())
            {
                ...
                {
                    Debug.Log("12222222222222222222222222222222222222222222");
                    playNormalAni = false;
        ...
        void GiveMonsterPrioritySkill()
        {
            ...
            {
                whichSkill = skillShade[1].fillAmount == 0 ? skill2.gameObject : skill1.gameObject;
            }
            else
            {
                ...
                if (skillShade[2].fillAmount == 0 &&
                    ReadJsonfiles.Instance.skillDics[roleconWhole.m_RoleInfo.skillid2].isnpcskill >
        ...
        bool JudgeSkillCDCanUse(GameObject obj)
        {
            ...
            else if (whichSkill.name.Equals(SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillid2.ToString()) &&
                     SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillCd2 == 0)
            {
                return false;
            }
            else if (whichSkill.name.Equals(SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillid3.ToString()) &&
                     SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillCd3 == 0)
                return false;
            else
                return true;
        ...
        void RemoveTheDeadMonster(RoleConfig target_roleIns)
        {
            ...
            CreatSkeleton.Instance.monsterBloods.Remove(
                CreatSkeleton.Instance.BloodsObjDic[target_roleIns.iddif].gameObject);
            ...
            CreatSkeleton.Instance.monsterSkeletonsMonsterBattleAni.Remove(target_roleIns
                .GetComponent<SkeletonAnimation>()); //新添加--测试技能伤害计算
            target_roleIns.gameObject.SetActive(false);

            ADDUIBattle.instance.battleCurrentAll.Remove(
                CreatSkeleton.Instance.skeletonsMonsterBattleAniDic[target_roleIns.iddif]);
        ...
        IEnumerator WaitRoleBackOldPos()
        {
            ...
            if (!isAlreadyFinish)
                AudioManager.Instance.SendMsg(
                    AudioMsgDetail.GetInstance.ChangeInfo((ushort) AudioId.search, is_NeedWait: true));
        ...
        void GetRoleTargetInfos(GameObject obj)
        {
            ...
            SkillEffect.Instance.savetarget_roleIns = CreatSkeleton.Instance
                .skeletonsBattleAniDic[ReadJsonfiles.Instance.roleIds[ran]].GetComponent<RoleConfig>();
            target_roleIns = CreatSkeleton.Instance.skeletonsBattleAniDic[ReadJsonfiles.Instance.roleIds[ran]]
        ...
        void ReMoveTheDeadRole()
        {
            ...
            ADDUIBattle.instance.battleCurrentAll.Remove(
                CreatSkeleton.Instance.skeletonsBattleAniDic[target_roleIns.id]);
            for (int i = 0; i < ADDUIBattle.instance.speedImages.Count; i++)
            {
...
//                        RoleMove.instance.mainCamera.GetComponent<Camera>().fieldOfView = 30f;
        ...
        IEnumerator ChangePos(GameObject obj, SkeletonAnimation attacker, bool attackIsRole)
        {
            ...
            if (!attackIsRole)
                yield return new WaitForSeconds(monsterAniDurationTime);
            ...
            if (Vector3.Distance(attacker.transform.position, target_roleIns.transform.position) < 161f)
            {
                if (attackIsRole)
                {
                    ...
                    if (recordSkillName == "skill3a")
                    {
                        Debug.LogError("等待时间2：--" + roleAniDurationTime);
                ...
                else
                {
                    ...
                    {
                        Debug.LogError("等待时间2：--" + roleAniDurationTime);
                        yield return new WaitForSeconds(roleAniDurationTime - 0.1f);
                        MonsterSpineAniManager.Instance.SendMsg(
                            ButtonMsg.GetInstance.ChangeInfo((ushort) MonsterSpineAniId.attack, roleconWhole.iddif,
                                "skill3c"));
                    }
//                    PassSkiiTargetSendAttacked(attackIsRole);
            ...
            Debug.LogError(roleAniDurationTime + "..............................................................");
            Debug.LogError(monsterAniDurationTime + "..............................................................");
            if (attackIsRole)
...
//                PassSkiiTargetSendIdle(attackIsRole);
        ...
        IEnumerator MonsterNotChangePos(RoleConfig target_roleIns, bool isSingle = true)
        {
            ...
            Debug.Log("加血模式下的等待时间：-----------------------------------------------" + monsterAniDurationTime);
            yield return new WaitForSeconds(monsterAniDurationTime);
            MonsterSpineAniManager.Instance.SendMsg(ButtonMsg.GetInstance.ChangeInfo((ushort) MonsterSpineAniId.attack,
                roleconWhole.iddif, recordSkillName));
            ...
            if (recordSkillName == "skill3a")
            {
                ...
                yield return new WaitForSeconds(monsterAniDurationTime);
                RoleSpineAniManager.Instance.SendMsg(ButtonMsg.GetInstance.ChangeInfo((ushort) RoleSpineAniId.attack,
                    (ushort) roleconWhole.m_RoleInfo.roleid, "skill3c"));
                yield return new WaitForSeconds(monsterAniDurationTime);
            }
        ...
        IEnumerator RoleNotChangePos(RoleConfig target_roleIns, bool isSingle = true)
        {
            ...
            RoleSpineAniManager.Instance.SendMsg(ButtonMsg.GetInstance.ChangeInfo((ushort) RoleSpineAniId.attack,
                roleconWhole.id, recordSkillName));
            Debug.LogError(roleAniDurationTime);
        ...
        void AgainAttack(bool attackIsRole = false)
        {
            ...
            SetConfig.TestVer("setceshi", singleTestBool: true, changBool: SkillEffect.Instance.canStrikeBack,
                debugInfo: "反击开启");
        ...
        void CalculateSkillCDSingle()
        {
            ...
            if (int.Parse(whichSkill.name) == SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillid2)
                SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillCd2 -= 1;
            if (int.Parse(whichSkill.name) == SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillid3)
                SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillCd3 -= 1;
            if (SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillid2 < 0)
                SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillid2 = 0;
            if (SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillid3 < 0)
                SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillid3 = 0;
        ...
        void RefreshSkillCD(bool attackIsRole, GameObject obj, bool select = false)
        {
            ...
            skillShade[1].fillAmount = (float) (SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillCd2) / ReadJsonfiles
                                           .Instance.skillDics[SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillid2]
                                           .skillcd;
            continueBoutText[1].text = SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillCd2 + "回合";

            if (isSkillId3)
            {
                skillShade[2].fillAmount = (float) (SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillCd3) /
                                           ReadJsonfiles
                                               .Instance.skillDics[
                                                   SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillid3]
                                               .skillcd;
            ...
            if (ReturnSkill3FillAmount(SkillEffect.Instance.attack_roleIns, attackIsRole) == 1 ||
                SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillCd3 == 0)
            {
        ...
        {
            return (float) (SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillCd2) / ReadJsonfiles.Instance
                       .skillDics[SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillid2].skillcd;
        }

        float ReturnSkill3FillAmount(RoleConfig role, bool attackIsRole)
        {
            if (attackIsRole && isSkillId3)
                return (float) (SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillCd3) / ReadJsonfiles.Instance
                           .skillDics[SkillEffect.Instance.attack_roleIns.m_RoleInfo.skillid3].skillcd;
            else
                return 2;
        }
