...
public partial class SkillEffect {
    ...
    public void RefreshBuff () {
        ...
        if (attack_roleIns.m_RoleInfo.isDizzinessCount == 0 && attack_roleIns.m_RoleInfo.isDizziness) {
            ...
            int id = ReturnId ();
            MonsterSpineAniManager.Instance.SendMsg (ButtonMsg.GetInstance.ChangeInfo ((ushort) MonsterSpineAniId.idle, id));
        }
        ...
        if (attack_roleIns.id == 10004) {
            if (attack_roleIns.m_RoleInfo.isProjectTeammateCount == 0 && attack_roleIns.m_RoleInfo.isProjectTeammate) {
    ...
    public void CompareCalculate (string buffName, int value, RoleConfig attack_roleIns) {
        switch (buffName) {
            case ("ForceAttack"):
                if (attack_roleIns.m_RoleInfo.isForceAttackCount != 0) attack_roleIns.m_RoleInfo.isForceAttackCount -= value;
                break;
            case ("MagicNail"):
                if (attack_roleIns.m_RoleInfo.isMagicNailCount != 0) attack_roleIns.m_RoleInfo.isMagicNailCount -= value;
                break;
            case ("Dizziness"):
                if (attack_roleIns.m_RoleInfo.isDizzinessCount != 0) attack_roleIns.m_RoleInfo.isDizzinessCount -= value;
                break;
            case ("Silience"):
                if (attack_roleIns.m_RoleInfo.isSilienceCount != 0) attack_roleIns.m_RoleInfo.isSilienceCount -= value;
                break;
            case ("AttackAdd"):
                if (attack_roleIns.m_RoleInfo.isAttackAddCount != 0) attack_roleIns.m_RoleInfo.isAttackAddCount -= value;
                break;
            case ("AttackReduce"):
                if (attack_roleIns.m_RoleInfo.isAttackReduceCount != 0) attack_roleIns.m_RoleInfo.isAttackReduceCount -= value;
                break;
            case ("DefenceAdd"):
                if (attack_roleIns.m_RoleInfo.isDefenceAddCount != 0) attack_roleIns.m_RoleInfo.isDefenceAddCount -= value;
                break;
            case ("DefenceReduce"):
                if (attack_roleIns.m_RoleInfo.isDefenceReduceCount != 0) attack_roleIns.m_RoleInfo.isDefenceReduceCount -= value;
                break;
            case ("SpeedReduce"):
                if (attack_roleIns.m_RoleInfo.isSpeedReduceCount != 0) attack_roleIns.m_RoleInfo.isSpeedReduceCount -= value;
                break;
                // case ("ProjectTeammate"):
                //     if (attack_roleIns.m_RoleInfo.isProjectTeammateCount != 0) attack_roleIns.m_RoleInfo.isProjectTeammateCount -= value;
                //     break;
